...
<nav class="navbar navbar-expand-lg navbar-dark bg-primary">
	<a class="navbar-brand" href="index.jsp"> <i
		class="fa-solid fa-square-phone"></i> Phone Book
	</a>
	...
	<div class="collapse navbar-collapse" id="navbarSupportedContent">
		<ul class="navbar-nav mr-auto">
			...
			<li class="nav-item active"><a class="nav-link"
				href="addContact.jsp"> <i class="fa-solid fa-address-card"></i>
					Add Phone No
			</a></li>
			<li class="nav-item active"><a class="nav-link"
		...
		<form class="form-inline my-2 my-lg-0">
			<a href="login.jsp" class="btn btn-success" ml> <i
		...
		<form class="form-inline my-2 my-lg-0">
			...
			<a data-toggle="modal"
		data-target="#exampleModalCenter"  class="btn btn-danger text-white" style="margin-left: 9px">Logout</a>
		</form>
		<%
		}
		%>
